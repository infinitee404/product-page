...
const CartContent = () => {
	...
	return (
		<div className='cursor-default absolute top-20 w-[20rem] bg-white border border-gray-200 shadow-lg p-4 rounded-lg z-5 min-h-[12rem]'>
			<h3 className='text-lg font-semibold border-b'>Cart</h3>
			<div className='h-[8rem] font-bold flex justify-between w-full items-center'>
				{cartItem.count === 0 ? (
					<p className='text-gray-500 mx-auto'>{cartText}</p>
				) : (
					<div className='flex flex-col justify-between h-full w-full'>
						<div className='mt-4 flex font-normal items-center gap-2'>
							<img
