	...
	return (
		<>
			<div className='max-md:hidden'>
				<div className='cart-component cursor-default absolute top-20 right-0 w-[20rem] bg-white border border-gray-200 shadow-lg p-4 rounded-lg z-40 min-h-[12rem]'>
					<CartDetails />
				</div>
			</div>
			<div className='md:hidden'>
				<div className='cursor-default fixed top-[4.5rem] left-[15vw] w-[70vw] bg-white border border-gray-200 shadow-lg p-4 rounded-lg z-40 min-h-[12rem]'>
					<CartDetails />
				</div>
			</div>
		</>
